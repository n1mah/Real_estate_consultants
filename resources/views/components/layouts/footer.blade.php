<div>
    ...
    <footer class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 min-h-15-vh items-center">
        <div class="items-center grid-flow-col">
            ...
            <p>تولید و توسعه  <br/>مهندس نیما حیدری - دکتر فتحی نوید</p>
        </div>
