...
<div class="text-center text-primary">
        ...
        <div class="px-4 py-2 mx-auto flex-col flex items-center justify-center">
            <h2 class="font-medium p-3 text-gray-400"> <span class="font-bold">مشاهده ماده 7</span></h2>
            <hr class="p-2 w-full">
            <div class="w-full flex flex-col items-center">
                <form class="py-2 w-full flex flex-col items-center">
                    <div class="w-full-80 mx-auto items-center mb-4 p-5">
                      <div>
                          <p>طرفین کلیه خیارات ولو خیار غبن به استثنا خیار تدلیس را از خود سلب و ساقط نمودند</p>
                      </div>
                    </div>
