<section class="bg-gray-200 dark:bg-gray-900 p-3 sm:p-5 bg-white  min-h-100-vh">
    <div class="w-full-65 px-4 py-2 mx-auto flex-col flex items-center justify-center">
        <h2 class="font-medium p-3 text-gray-400">کنسل کردن قرارداداجاره</h2>
        <hr class="p-2 w-full">
        ...
        <a href="{{route('rents')}}" class="p-4 bg-primary-600 text-white rounded-[10px]"> انصراف و بازگشت به صفحه اجاره نامه ها</a>
    </div>
</section>
