                    ...
                    @foreach($people as $person)
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 flex items-center justify-center">
                                ...
                                <button wire:click="$emit('openModal', 'people.show', {{ json_encode(['person_get' => $person->id]) }})" type="button" class="px-2 py-1.5 text-xs font-medium text-center focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 rounded-lg dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">حذف</button>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
