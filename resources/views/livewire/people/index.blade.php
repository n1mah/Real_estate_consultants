                    ...
                    @foreach($people as $person)
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 flex items-center justify-center">
                                ...
                                <button wire:click="$emit('openModal', 'people.edit')" type="button" class="px-2 py-1.5 mx-1.5 text-xs font-medium text-center focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 rounded-lg dark:focus:ring-yellow-900">ویرایش</button>
