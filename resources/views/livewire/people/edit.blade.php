<section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5"  style="min-height: 100vh">
    <div class="text-center text-primary">
        <h1 class="font-bold text-3xl p-5 text-warning">ویرایش مشتری</h1>
        <hr>
    </div>
    <div class="max-w-3xl px-4 py-2 mx-auto">
        <form wire:submit.prevent="update" class="py-2">
            <div class="grid gap-4 mb-4 sm:grid-cols-3 sm:gap-6 sm:mb-5">
                ...
                <div class="w-full">
                    <label for="firstname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">نام <span class="text-yellow-400 text-xl relative top-1.5 leading-none">*</span></label>
                ...
                <div class="w-full">
                    <label for="lastname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">نام خانوادگی<span class="text-yellow-400 text-xl relative top-1.5 leading-none">*</span></label>
                ...
                <div class="w-full">
                    <label for="fathername" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">نام پدر<span class="text-yellow-400 text-xl relative top-1.5 leading-none">*</span></label>
                ...
                <div class="w-full">
                    <label for="birth_certificate_number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">شماره شناسنامه<span class="text-yellow-400 text-xl relative top-1.5 leading-none">*</span></label>
                ...
                <div class="w-full">
                    <label for="place_of_birth" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">محل تولد<span class="text-yellow-400 text-xl relative top-1.5 leading-none">*</span></label>
                ...
                <div class="w-full">
                    <label for="postal_code" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">کد پستی<span class="text-yellow-400 text-xl relative top-1.5 leading-none">*</span></label>
                ...
                <div class="w-full">
                    <label for="mobile" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">موبایل<span class="text-yellow-400 text-xl relative top-1.5 leading-none">*</span></label>
                ...
                <x-persian-datepicker
                    ...
                    id="date_of_birth"
                >
                    <label for="date_of_birth" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">تاریخ تولد<span class="text-yellow-400 text-xl relative top-1.5 leading-none">*</span></label>
                ...
                <div class="sm:col-span-3">
                    <label for="address" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">آدرس<span class="text-yellow-400 text-xl relative top-1.5 leading-none">*</span></label>
            ...
            <div class="flex items-center space-x-4">
                <button wire:click="$emit('editAction')" type="submit" class="ml-4 text-white bg-warning-500 hover:bg-warning-500 focus:ring-4 focus:outline-none focus:ring-warning-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-warning-300 dark:hover:bg-warning-500 dark:focus:ring-warning-500">
                    ویرایش مشتری
                </button>
